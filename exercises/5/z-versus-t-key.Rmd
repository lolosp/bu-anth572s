...
ggplot(data = data.frame(x = c(-4, 4)), aes(x)) +
  ...
  geom_area(stat = 'function', fun = dnorm, args = list(mean = 0, sd = 1), fill = "red", alpha = 0.4, xlim = c(1.64, 4))+ # modify the xlim argument
...
H~0~: The mean wear time is 60,000mi
H~1~: The mean wear time is not 60,000mi
...
0.025 on each tail, or the cutpoints: 0.025 and 0.975 

#### 3.3. Determine which type of test you should use

z test because you have tested more than 30 tires
