...
```{r}
reg1 <- lm(price ~ carat + cut, data = diamonds)
```
...
Holding all else equal, an increase of 1 unit. in length results in a 0.19 unit increase in weight.

Holding all else equal, an increase of 1 unit in width results in an increase of 0.34 units in weight
...
R-squared = 0.8335. Our model, which accounts for length and width, explains 83.35% of the variation in the outcome, weight.
